...
public class AccessControlAspectsQuiz {
	...
	@Around("execution(* quiz.demo.data.repository.QuizRepository.save(..)) && args(quiz,..)")
	...
	@Around("execution(* quiz.demo.data.repository.QuizRepository.findById(Long)) && args(id)")
	...
	@Around("execution(* quiz.demo.data.repository.QuizRepository.findAll())")
	...
	@Around("execution(* quiz.demo.data.repository.QuizRepository.delete(..)) && args(quiz)")
