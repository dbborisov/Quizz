...
public class AccessControlAspectsQuestion {
	...
	@Around("execution(* quiz.demo.data.repository.QuestionRepository.save(..)) && args(question)")
	...
	@Around("execution(* quiz.demo.data.repository.QuestionRepository.findById(Long)) && args(id)")
	...
	@Around("execution(* quiz.demo.data.repository.QuestionRepository.findAll())")
	...
	@Around("execution(* quiz.demo.data.repository.QuestionRepository.delete(..)) && args(question)")
