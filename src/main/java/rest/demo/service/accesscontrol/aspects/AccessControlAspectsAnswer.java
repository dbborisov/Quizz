...
public class AccessControlAspectsAnswer {
	...
	@Around("execution(* rest.demo.data.repository.AnswerRepository.save(..)) && args(answer)")
	...
	@Around("execution(* rest.demo.data.repository.AnswerRepository.findById(Long)) && args(id)") //todo
	...
	@Around("execution(* rest.demo.data.repository.AnswerRepository.findAll())")
	...
	@Around("execution(* rest.demo.data.repository.AnswerRepository.delete(..)) && args(answer)")
