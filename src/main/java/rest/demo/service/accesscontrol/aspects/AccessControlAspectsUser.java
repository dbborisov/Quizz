...
public class AccessControlAspectsUser {
	...
	@Around("execution(* rest.demo.data.repository.UserRepository.save(..)) && args(user)")
	...
	@Around("execution(* rest.demo.data.repository.UserRepository.find(Long)) && args(id)")
	...
	@Around("execution(* rest.demo.data.repository.UserRepository.findAll())")
	...
	@Around("execution(* rest.demo.data.repository.UserRepository.delete(..)) && args(user)")
